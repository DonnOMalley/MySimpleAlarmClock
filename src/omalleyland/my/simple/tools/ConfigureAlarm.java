...
public class ConfigureAlarm extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(ConfigureAlarm.this, "Exception:: " + e.getMessage(), Toast.LENGTH_LONG).show();
        }
    } 	
    ...
    public void SetAlarm(boolean AlarmEnabled, int AlarmHour, int AlarmMin) {
        if (AlarmEnabled) {   
    		...
    		Intent AlarmIntent = new Intent(ConfigureAlarm.this, AlarmReceiver.class);
        	AlarmManager AlmMgr = (AlarmManager)getSystemService(ALARM_SERVICE);
        	PendingIntent Sender = PendingIntent.getBroadcast(ConfigureAlarm.this, 0, AlarmIntent, 0);    	
